...
const HomePage = (props: Props) => {
  ...
  const [currentDelayTime, setCurrentDelayTime] = useState<number>(
    delayTime / 1000
  );
            ...
            <Popover>
              ...
              <PopoverContent>
                <div className="flex items-center">
                  <span className="mr-2">
                    Delay Time: {currentDelayTime.toFixed(0)} seconds
                  </span>
                  <Slider
      ...
      <div className="text-xs text-muted-foreground">
        <ul className="space-y-4">
          ...
          <li>
            ...
            <p>
              Set a delay before the recording is stopped. <br />
        ...
        <div className="mt-auto pt-20 text-center text-xs text-muted-foreground">
          © 2024 Beny Dishon. All rights reserved.
        </div>
      </div>
    );
  }
